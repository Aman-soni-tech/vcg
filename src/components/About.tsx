  ...
  return (
    <section className="pt-24 pb-16 md:pt-32 md:pb-24 bg-white">
      <div className="container-custom">
        ...
        <button
          onClick={onBackClick}
          className="mb-8 flex items-center gap-2 text-primary-700 hover:text-primary-800 font-semibold transition-colors"
        >
        ...
        <div className="mb-12 animate-fade-in">
          ...
          <div className="grid md:grid-cols-1 gap-8">
            <div className="p-8 rounded-2xl border border-gray-200 hover:border-primary-300 hover:shadow-medium transition-all duration-300 bg-gradient-to-br from-white to-gray-50">
        ...
        <div className="grid md:grid-cols-2 gap-8 stagger-children">
          {/* Mission Card */}
          <div className="p-8 rounded-2xl border border-gray-200 hover:border-primary-300 hover:shadow-medium transition-all duration-300 group bg-gradient-to-br from-blue-50 to-white">
            <div className="flex items-center gap-4 mb-6">
              <div className="p-3 bg-gradient-primary rounded-lg text-white w-fit group-hover:scale-110 transition-transform duration-300">
          ...
          {/* Vision Card */}
          <div className="p-8 rounded-2xl border border-gray-200 hover:border-primary-300 hover:shadow-medium transition-all duration-300 group bg-gradient-to-br from-purple-50 to-white">
            <div className="flex items-center gap-4 mb-6">
              <div className="p-3 bg-gradient-accent rounded-lg text-white w-fit group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
